...
<body>   
    <div style=" font-family: 'Poppins';line-height: 0;display: flex;flex-direction: row;justify-content: center;padding: 0 3rem;text-align: center;" class="market-header">
        <h1 style="font-weight: 600;font-size: 40px;color: #FA632A;padding-top: 4.5rem;padding-bottom: 4rem;text-align: center;" id="header">YOUR BOOKING HAS BEEN ACCEPTED</h1>
    </div>
